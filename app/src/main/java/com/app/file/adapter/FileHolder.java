...
import com.app.file.FileUtil;
import com.app.file.R;
import com.app.file.adapter.base.RecyclerViewAdapter;
import com.app.file.adapter.base.RecyclerViewHolder;
...
public class FileHolder extends RecyclerViewHolder<FileHolder> {
    ...
    public void onBindViewHolder(final FileHolder fileHolder, RecyclerViewAdapter adapter, int position) {
        ...
        if (fileType == FileType.directory) {
            ...
            fileHolder.fileIcon.setImageBitmap(BitmapFactory.decodeFile(fileBean.getPath()));
